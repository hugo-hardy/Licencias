...
--
-- Table structure for table `log_impresion`
--

DROP TABLE IF EXISTS `log_impresion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `log_impresion` (
  `id_log_impresion` int(11) NOT NULL AUTO_INCREMENT,
  `fecha` datetime DEFAULT NULL,
  `id_usuario` int(11) DEFAULT NULL,
  `id_impresion` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `log_impresion`
--
